...
ARCHIVE_ROOT = PROMOTION_ROOT / "archived-3.14.7-t1os.65"
JOURNAL = PROMOTION_ROOT / "promotion-journal.json"
RELEASE = "3.14.7-t1os.66"
VERSION = "3.14.7"
ABI = "cp314"
...
def build_definition_records() -> list[dict]:
    ...
    relative_paths = [
        ...
        "scripts/build/build python runtime.ps1",
        "scripts/build/build python 3.14 candidate.ps1",
        "scripts/build/package python 3.14 candidate.ps1",
        "scripts/tests/test python runtime.ps1",
        "scripts/audits/validate profiled python entrypoints.py",
        "scripts/audits/validate profiled python entrypoints.ps1",

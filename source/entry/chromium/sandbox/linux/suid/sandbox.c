...
//
// T1OS has no /proc aliases and never uses symbolic links.  Chromium creates
// this empty, root-owned directory under its permitted ephemeral runtime.
#define SAFE_DIR "/.ephemeral/chromium/sandbox-root"
#define SAFE_DIR2 "/.ephemeral/chromium/sandbox-root"

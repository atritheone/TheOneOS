...
/bin/busybox mkdir -m 0750 "/mnt/.ephemeral/volumes" || exec /bin/busybox sh
/bin/busybox chown 0:1000 "/mnt/.ephemeral/volumes" || exec /bin/busybox sh
/bin/busybox chmod 0750 "/mnt/.ephemeral/volumes" || exec /bin/busybox sh

...
$contractPath = Join-Path $projectRoot 'resource\entry\roothealth\REPAIR-CONTRACT.md'
$rolloutPath = Join-Path $projectRoot 'resource\entry\roothealth\ROLLOUT-v0.5.1.md'
$qualificationPath = Join-Path $projectRoot 'resource\entry\roothealth\QUALIFICATION-v0.5.1.md'
$failureTaxonomyPath = Join-Path $projectRoot 'resource\entry\roothealth\FAILURE-TAXONOMY-v1.md'

...
for option in SECURITY_T1OS DEVTMPFS SCSI BLK_DEV_SD ATA SATA_AHCI ATA_PIIX EXT4_FS VIRTIO VIRTIO_PCI VIRTIO_NET DRM DRM_VMWGFX VBOXGUEST VBOXSF_FS SND SND_HDA_INTEL SND_INTEL8X0 SERIAL_8250 SERIAL_8250_CONSOLE USB_XHCI_HCD USB_XHCI_PCI HID HID_GENERIC USB_HID INPUT_EVDEV; do

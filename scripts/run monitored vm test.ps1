...
$testScript = Join-Path $PSScriptRoot 'test t1os vm.ps1'
$hardwareRoot = Join-Path $projectRoot 'environment\hardware'
$stdoutPath = Join-Path $hardwareRoot 't1os-vm-monitored.stdout.log'
$stderrPath = Join-Path $hardwareRoot 't1os-vm-monitored.stderr.log'

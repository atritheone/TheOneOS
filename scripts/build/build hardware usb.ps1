...
$steps = @(
    [pscustomobject]@{
        ...
        Script = 'build\stage hardware firmware.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
        Name = 'build the hardware kernel and modules'
        Script = 'build\build hardware kernel.ps1'
    ...
    [pscustomobject]@{
        ...
        Script = 'build\build graphics runtime.ps1'
    ...
    [pscustomobject]@{
        ...
        Script = 'build\build chromium runtime.ps1'
        Arguments = @('-Profile', 'release')
    },
    [pscustomobject]@{
        Name = 'audit T1OS source runtime paths'
        Script = 'audits\audit t1os runtime paths.ps1'
    ...
    [pscustomobject]@{
        ...
        Script = 'tests\test roothealth repair.ps1'
        Arguments = @(
    ...
    [pscustomobject]@{
        ...
        Script = 'build\build hardware initramfs.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
        Name = 'synchronise T1OS into storage.img'
        Script = 'deployment\push to disk.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        ...
        Script = 'tests\test chromium runtime.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
        Name = 'validate hardware build artifacts'
        Script = 'tests\test hardware build.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        ...
        Script = 'tests\test video compatibility.ps1'
        Arguments = @()
    },
    [pscustomobject]@{
...
elseif (-not $SkipQemu) {
    $steps += [pscustomobject]@{
        ...
        Script = 'tests\test hardware usb qemu.ps1'
        Arguments = @()
    }
}
...
if (Test-T1OSDiskMounted) {
    throw 'environment/software/storage.img is mounted. Unmount it before starting the hardware USB workflow.'
}

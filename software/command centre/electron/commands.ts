...
export const commandCatalogue = {
  'mount-disk': command({
    ...
    script: 'deployment/mount.ps1', disk: 'unmounted',
  }),
  ...
  'create-usb-user': command({
    ...
    script: 'deployment/create disk user.ps1', arguments: ['-UsbDrive'], input: 'create-user',
  }),
  'change-usb-user': command({
    ...
    script: 'deployment/change disk user.ps1', arguments: ['-UsbDrive'], input: 'change-user',
  }),
  'remove-usb-user': command({
    ...
    script: 'deployment/remove disk user.ps1', arguments: ['-UsbDrive'], input: 'remove-user',
  }),
  'toggle-debug': command({
    label: 'toggle debug mode', detail: 'switch all recognised T1OS debug flags together', group: 'workspace',
    script: 'tools/toggle debug mode.ps1', disk: 'mounted',
  }),
  ...
  'push-to-disk': command({
    ...
    script: 'deployment/push to disk.ps1', disk: 'unmounted', recordsPush: true,
  }),
  'push-to-disk-fast': command({
    ...
    script: 'deployment/push to disk.ps1', arguments: ['-Fast'], disk: 'unmounted', recordsPush: true, advanced: true,
  }),
  'push-to-drive': command({
    ...
    script: 'deployment/push to disk.ps1', arguments: ['-UsbDrive'], recordsPush: true,
  }),
  'validate-drive-target': command({
    ...
    script: 'deployment/push to disk.ps1', arguments: ['-UsbDrive', '-ValidateTargetOnly'], advanced: true,
  }),
  'prepare-prod': command({
    ...
    script: 'build/prepare prod build.ps1', disk: 'known',
  ...
  'update-usb-with-boot': command({
    ...
    script: 'deployment/update t1os usb.ps1', arguments: ['-IncludeBoot'],
  ...
  'update-usb-full': command({
    ...
    script: 'deployment/update t1os usb.ps1', arguments: ['-Full', '-IncludeBoot'],
  ...
  'prepare-usb-maintenance': command({
    ...
    script: 'deployment/update t1os usb.ps1', arguments: ['-Prepare'],
  ...
  'build-image-catalogue': command({
    ...
    script: 'build/build image catalogue.ps1',
  }),
  'build-graphics-vm': command({
    ...
    script: 'build/build graphics runtime.ps1', arguments: ['-Profile', 'vm'],
  }),
  'build-graphics-hardware': command({
    ...
    script: 'build/build graphics runtime.ps1', arguments: ['-Profile', 'hardware', '-EnableNvidia'],
  }),
  'build-audio-release': command({
    ...
    script: 'build/build audio runtime.ps1',
  }),
  ...
  'build-virtualbox-runtime': command({
    ...
    script: 'vm/build virtualbox runtime.ps1',
  }),
  'build-chromium-release': command({
    ...
    script: 'build/build chromium runtime.ps1', arguments: ['-Profile', 'release'],
  }),
  'build-chromium-development': command({
    ...
    script: 'build/build chromium runtime.ps1', arguments: ['-Development'], advanced: true,
  }),
  ...
  'build-vm-kernel': command({
    ...
    script: 'build/build graphics kernel.ps1', advanced: true,
  }),
  ...
  'verify-python-runtime': command({
    ...
    script: 'build/build python runtime.ps1',
  }),
  'rebuild-python-runtime': command({
    ...
    script: 'build/build python runtime.ps1', arguments: ['-Rebuild'],
  ...
  'stage-python-candidate': command({
    ...
    script: 'build/build python runtime.ps1', arguments: ['-StageOnly'], advanced: true,
  }),
  'promote-python-candidate': command({
    ...
    script: 'build/build python runtime.ps1', arguments: ['-Promote'],
  ...
  'test-python-runtime': command({
    ...
    script: 'tests/test python runtime.ps1',
  }),
  'audit-python-provenance': command({
    ...
    script: 'audits/audit python provenance.ps1',
  }),
  'diagnose-python-source': command({
    ...
    script: 'build/build python source diagnostic.ps1', advanced: true,
  }),
  'build-python-candidate': command({
    ...
    script: 'build/build python 3.14 candidate.ps1', advanced: true,
  }),
  'push-python-candidate': command({
    ...
    script: 'deployment/push python 3.14 candidate to storage.ps1', disk: 'unmounted', advanced: true,
  }),
  ...
  'validate-vbox': command({
    ...
    script: 'vm/run vbox.ps1', arguments: ['-ValidateOnly'], advanced: true,
  }),
  'convert-vbox': command({
    ...
    script: 'vm/convert vbox.ps1', disk: 'unmounted', advanced: true,
  }),
  ...
  'validate-vmware': command({
    ...
    script: 'vm/run vmware.ps1', arguments: ['-ValidateOnly'], advanced: true,
  }),
  'convert-vmware': command({
    ...
    script: 'vm/convert vmware.ps1', disk: 'unmounted', advanced: true,
  }),
  'test-vm-setup': command({
    ...
    script: 'tests/test vm setup.ps1',
  }),
  'prepare-vm-test': command({
    ...
    script: 'vm/prepare vm test vbox.ps1', advanced: true,
  }),
  ...
  'test-vm-features': command({
    ...
    script: 'tests/test t1os vm.ps1', arguments: ['-Suite', 'Features'], advanced: true,
  }),
  'test-vm-full': command({
    ...
    script: 'tests/test t1os vm.ps1', arguments: ['-Suite', 'Full'],
  ...
  'monitor-vm-full': command({
    ...
    script: 'vm/run monitored vm test.ps1', arguments: ['-Suite', 'Full'], advanced: true,
  }),
  'test-release-vbox': command({
    ...
    script: 'tests/test release vbox.ps1',
  }),
  'test-release-vmware': command({
    ...
    script: 'tests/test release vmware.ps1',
  }),
  'extract-vbox-logs': command({
    ...
    script: 'vm/extract vbox logs.ps1',
  }),
  'test-graphics-vbox': command({
    ...
    script: 'tests/test graphics vbox.ps1', advanced: true,
  }),
  'test-graphics-matrix': command({
    ...
    script: 'tests/test graphics vbox.ps1', arguments: ['-Matrix'], advanced: true,
  }),
  'test-video-vbox': command({
    ...
    script: 'tests/test video vbox.ps1', advanced: true,
  }),
  'test-vbox-resize': command({
    ...
    script: 'tests/test virtualbox resize.ps1', advanced: true,
  }),
  ...
  'install-hardware-deps': command({
    ...
    script: 'deployment/install hardware build dependencies.ps1',
  ...
  'plan-hardware-usb': command({
    ...
    script: 'build/build hardware usb.ps1', arguments: ['-PlanOnly'],
  }),
  'build-hardware-usb': command({
    ...
    script: 'build/build hardware usb.ps1', disk: 'unmounted', recordsPush: true,
  ...
  'build-hardware-no-qemu': command({
    ...
    script: 'build/build hardware usb.ps1', arguments: ['-SkipQemu'], disk: 'unmounted', recordsPush: true, advanced: true,
  ...
  'create-hardware-image': command({
    ...
    script: 'build/build hardware usb.ps1', arguments: ['-ArtifactsOnly'], disk: 'unmounted',
  ...
  'stage-hardware-firmware': command({
    ...
    script: 'build/stage hardware firmware.ps1', advanced: true,
  }),
  'build-hardware-kernel': command({
    ...
    script: 'build/build hardware kernel.ps1', advanced: true,
  }),
  'build-hardware-initramfs': command({
    ...
    script: 'build/build hardware initramfs.ps1', advanced: true,
  }),
  'configure-hardware-wireless': command({
    ...
    script: 'deployment/configure hardware wireless.ps1', input: 'wireless', advanced: true,
  }),
  'push-hardware-kernel-usb': command({
    ...
    script: 'deployment/push hardware kernel to usb.ps1', confirm: 'update the boot payload on the validated T1OS USB?', advanced: true,
  }),
  'push-python-usb': command({
    ...
    script: 'deployment/push managed python to usb.ps1', advanced: true,
  }),
  'push-media-usb': command({
    ...
    script: 'deployment/push media runtime to usb.ps1', advanced: true,
  }),
  'push-chromium-usb': command({
    ...
    script: 'deployment/push chromium presentation to usb.ps1', advanced: true,
  }),
  ...
  'audit-runtime-paths': command({
    ...
    script: 'audits/audit t1os runtime paths.ps1', disk: 'unmounted',
  }),
  'audit-source-runtime-paths': command({
    ...
    script: 'audits/audit t1os runtime paths.ps1', arguments: ['-SkipStorageImage'], advanced: true,
  }),
  'audit-hardware-usb': command({
    ...
    script: 'audits/audit hardware usb boot.ps1', advanced: true,
  }),
  'validate-hardware-compatibility': command({
    ...
    script: 'audits/validate hardware compatibility.ps1',
  }),
  'test-hardware-build': command({
    ...
    script: 'tests/test hardware build.ps1',
  }),
  'test-hardware-build-image': command({
    ...
    script: 'tests/test hardware build.ps1', arguments: ['-IncludeUsbImage'], advanced: true,
  }),
  ...
  'test-hardware-qemu': command({
    ...
    script: 'tests/test hardware usb qemu.ps1',
  }),
  'test-video-compatibility': command({
    ...
    script: 'tests/test video compatibility.ps1',
  }),
  'test-roothealth': command({
    ...
    script: 'tests/test roothealth.ps1',
  }),
  'test-roothealth-repair': command({
    ...
    script: 'tests/test roothealth repair.ps1', advanced: true,
  }),
  'test-chromium-runtime': command({
    ...
    script: 'tests/test chromium runtime.ps1', disk: 'unmounted',
  }),
  'test-chromium-fonts': command({
    ...
    script: 'tests/test chromium fonts.ps1', advanced: true,
  }),
  'test-chromium-xwm': command({
    ...
    script: 'tests/test chromium xwm.ps1', advanced: true,
  }),
  'test-angel-recovery': command({
    ...
    script: 'tests/test angel recovery.ps1', advanced: true,
  }),
  'validate-profiled-python': command({
    ...
    script: 'audits/validate profiled python entrypoints.ps1', advanced: true,
  }),
